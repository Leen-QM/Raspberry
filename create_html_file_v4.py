def create_html_file():
    ...
    <head>
      ...
      <script src="pagescroll_v2.js" defer></script> <!-- Link to the separate JS file -->
    </head>
    ...
    <div class="scrollable">
      ...
      <div id="1" class="section part1">
            ...
            <audio id="audio1" src="Object 1 en.mp3" preload="auto"></audio>
      ...
      <div id="2" class="section part2">
            ...
            <audio id="audio2" src="Object 2 en.mp3" preload="auto"></audio>
      ...
      <div id="3" class="section part3">
            ...
            <audio id="audio3" src="Object 3 en.mp3" preload="auto"></audio>
      ...
      <div id="4" class="section part4">
            ...
            <audio id="audio4" src="Object 4 en.mp3" preload="auto"></audio>
